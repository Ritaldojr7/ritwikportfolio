        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-left my-[32px] mx-0 py-[25px] px-[10px] font-medium">Currently decoding AI mysteries and crafting software solutions at VIT, with a focus on health tech, NLP, and intelligent systems that (mostly) behave.</p>
